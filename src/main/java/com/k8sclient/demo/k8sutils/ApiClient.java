...
//        this.json = new JSON();
//        this.setUserAgent("Kubernetes Java Client/11.0.1-SNAPSHOT");
...
//                return this.downloadFileFromResponse(response);
//            } else {
//                String respBody;
//                try {
...
//        okhttp3.MultipartBody.Builder mpBuilder = (new okhttp3.MultipartBody.Builder()).setType(MultipartBody.FORM);
//        Iterator var3 = formParams.entrySet().iterator();
//
//        while(var3.hasNext()) {
//            Map.Entry<String, Object> param = (Map.Entry)var3.next();
